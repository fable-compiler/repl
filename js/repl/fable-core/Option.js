define(["exports", "./Types", "./Util"], function (exports, _Types, _Util) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.Result = exports.Choice = exports.Some = undefined;
    exports.some = some;
    exports.value = value;
    ...
    // CHOICE
    const Choice = exports.Choice = (0, _Types.declare)(function Choice(tag, name, field) {
    ...
    // RESULT
    const Result = exports.Result = (0, _Types.declare)(function Result(tag, name, field) {
        _Types.Union.call(this, tag, name, field);
    }, _Types.Union);
    function ok(x) {
