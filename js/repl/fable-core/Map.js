...
export function MapTreeModule$$$partitionAux($arg$$19, $arg$$20, $arg$$21, $arg$$22, $arg$$23) {
...
export function MapTreeModule$$$filterAux($arg$$32, $arg$$33, $arg$$34, $arg$$35) {
...
export function MapTreeModule$$$foldBack($arg$$55, $arg$$56, $arg$$57) {
...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    const activePatternResult3017 = e$$1.Current;
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3017[0]));
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3017[1]));
  }
