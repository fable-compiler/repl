define(["exports", "./Types", "./Option", "./List", "./Seq", "./String", "./Util"], function (exports, _Types, _Option, _List, _Seq, _String, _Util) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.FSharpMap = exports.MapTreeModule$002EmkIEnumerator$0027$00602 = exports.MapTreeModule$002EMapIterator$00602 = exports.MapTree$00602 = undefined;
  ...
  exports.FSharpMap$$TryPick$$Z52B03DBD = FSharpMap$$TryPick$$Z52B03DBD;
  ...
  exports.FSharpMap$$MapRange$$Z1D9544EB = FSharpMap$$MapRange$$Z1D9544EB;
  exports.FSharpMap$$Map$$Z5CD84AAA = FSharpMap$$Map$$Z5CD84AAA;
  ...
  exports.MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002ECollections$002EGeneric$002EIEnumerator$00601 = MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002ECollections$002EGeneric$002EIEnumerator$00601;
  exports.MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002ECollections$002EIEnumerator = MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002ECollections$002EIEnumerator;
  exports.MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002EIDisposable = MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002EIDisposable;
  const MapTree$00602 = exports.MapTree$00602 = (0, _Types.declare)(function MapTree$00602(tag, name, ...fields) {
  ...
  function MapTreeModule$$$partitionAux($arg$$10, $arg$$11, $arg$$12, $arg$$13, $arg$$14) {
    MapTreeModule$$$partitionAux: while (true) {
      ...
      if (s.tag === 1) {
        ...
        const acc1$$1 = acc$$1[0];
        const acc2$$1 = acc$$1[1];
        return MapTreeModule$$$partition1(comparer$$4, f$$1, k$$6, v$$4, acc1$$1, acc2$$1);
      } else if (s.tag === 2) {
        ...
        let acc$$2;
        const arg30$0040 = acc$$1[0];
        const arg31$0040 = acc$$1[1];
        acc$$2 = MapTreeModule$$$partitionAux(comparer$$4, f$$1, r$$5, arg30$0040, arg31$0040);
        let acc$$3;
        const acc1$$2 = acc$$2[0];
        const acc2$$2 = acc$$2[1];
        acc$$3 = MapTreeModule$$$partition1(comparer$$4, f$$1, k$$7, v$$5, acc1$$2, acc2$$2);
        const arg30$0040$$1 = acc$$3[0];
        const arg31$0040$$1 = acc$$3[1];
        $arg$$10 = comparer$$4;
        $arg$$11 = f$$1;
        $arg$$12 = l$$5;
        $arg$$13 = arg30$0040$$1;
  ...
  function MapTreeModule$$$filterAux($arg$$23, $arg$$24, $arg$$25, $arg$$26) {
  ...
  function MapTreeModule$$$iter(f$$6, m$$9) {
    if (m$$9.tag === 1) {
  ...
  function MapTreeModule$$$tryPick($arg$$32, $arg$$33) {
  ...
  function MapTreeModule$$$exists($arg$$34, $arg$$35) {
  ...
  function MapTreeModule$$$forall($arg$$36, $arg$$37) {
  ...
  function MapTreeModule$$$foldBack($arg$$42, $arg$$43, $arg$$44) {
  ...
  function MapTreeModule$$$fold($arg$$45, $arg$$46, $arg$$47) {
  ...
  function MapTreeModule$$$loop(m$$19, acc$$8) {
    MapTreeModule$$$loop: while (true) {
      if (m$$19.tag === 1) {
        ...
        m$$19 = l$$19;
        acc$$8 = (0, _Types.L)([k$$24, v$$20], MapTreeModule$$$loop(r$$19, acc$$8));
  ...
  function MapTreeModule$$$copyToArray(s$$4, arr$$1, i$$1) {
    var f$$16;
    let j = i$$1 | 0;
    (f$$16 = function f$$16(x$$15, y$$2) {
      arr$$1[j] = [x$$15, y$$2];
      j = j + 1;
    }, function (m$$21) {
      MapTreeModule$$$iter(f$$16, m$$21);
    })(s$$4);
  }
  const MapTreeModule$002EMapIterator$00602 = exports.MapTreeModule$002EMapIterator$00602 = (0, _Types.declare)(function MapTreeModule$002EMapIterator$00602(arg1, arg2) {
    this.stack = arg1;
    this.started = arg2;
  }, _Types.Record);
    ...
    MapTreeModule$$$collapseLHS: while (true) {
      if (stack.tail != null) {
        if (stack.head.tag === 1) {
          ...
          stack = (0, _Types.L)(stack.head.fields[2], (0, _Types.L)(new MapTree$00602(1, "MapOne", stack.head.fields[0], stack.head.fields[1]), (0, _Types.L)(stack.head.fields[3], stack.tail)));
  ...
  const MapTreeModule$002EmkIEnumerator$0027$00602 = exports.MapTreeModule$002EmkIEnumerator$0027$00602 = (0, _Types.declare)(function MapTreeModule$002EmkIEnumerator$0027$00602(s$$6) {
    const $this$$1 = this;
    $this$$1.s = s$$6;
  ...
  const FSharpMap = exports.FSharpMap = (0, _Types.declare)(function FSharpMap(comparer$$17, tree) {
    const $this$$2 = this;
  ...
  FSharpMap.prototype.toString = function () {
    var sep, mapping;
    const this$ = this;
    return "map [" + (sep = "; ", function (strings) {
      return (0, _String.join)(sep, strings);
    })((mapping = function mapping(kv) {
      var clo1;
      return (clo1 = (0, _String.toText)((0, _String.printf)("(%A, %A)")), function (arg10) {
  ...
  FSharpMap.prototype.GetHashCode = function () {
    ...
    while (e$$1.MoveNext()) {
      ...
      const activePatternResult2388 = patternInput$$5;
      const y$$4 = activePatternResult2388[1];
      const x$$17 = activePatternResult2388[0];
      res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(x$$17));
      res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(y$$4));
    }
  ...
  FSharpMap.prototype[Symbol.iterator] = function () {
    const __$$24 = this;
    return (0, _Seq.toIterator)(MapTreeModule$$$mkIEnumerator(__$$24.tree));
  };

  FSharpMap.prototype.CompareTo = function (obj) {
    const m$$22 = this;
    const m2 = (0, _Util.downcast)(obj);
    let res$$4 = 0;
    let finished = false;
  ...
  function pick(f$$29, m$$31) {
    ...
    if (matchValue$$7 != null) {
      const res$$5 = (0, _Option.value)(matchValue$$7);
      return res$$5;
    } else {
      throw new Error("key not found");
    }
  ...
  function findKey(f$$38, m$$41) {
    ...
    return function (_arg1$$1) {
      if (_arg1$$1 == null) {
        ...
        const k$$39 = (0, _Option.value)(_arg1$$1);
        return k$$39;
      }
    }((f$$39 = function f$$39(k$$38, v$$26) {
      if (f$$38(k$$38, v$$26)) {
        return (0, _Option.some)(k$$38);
      } else {
        return null;
      }
    }, function (m$$42) {
      return MapTreeModule$$$tryPick(f$$39, m$$42);
    })(FSharpMap$$get_Tree(m$$41)));
  }
  function tryFindKey(f$$40, m$$43) {
    var f$$41;
    return (f$$41 = function f$$41(k$$40, v$$27) {
      if (f$$40(k$$40, v$$27)) {
        return (0, _Option.some)(k$$40);
      } else {
        return null;
      }
    }, function (m$$44) {
      return MapTreeModule$$$tryPick(f$$41, m$$44);
  ...
  function createMutablePrivate(comparer$$22, tree$0027) {
    ...
    return {
      ...
      keys() {
        var mapping$$1;
        return (mapping$$1 = function mapping$$1(kv$$1) {
          return kv$$1[0];
        }, function (source$$1) {
          return (0, _Seq.map)(mapping$$1, source$$1);
      ...
      values() {
        var mapping$$2;
        return (mapping$$2 = function mapping$$2(kv$$2) {
          return kv$$2[1];
        }, function (source$$2) {
          return (0, _Seq.map)(mapping$$2, source$$2);
        })(MapTreeModule$$$toSeq(tree$$1));
      },
  ...
  function createMutable(source$$3, comparer$$23) {
    return function (tree$0027$$1) {
      return createMutablePrivate(comparer$$23, tree$0027$$1);
    }(MapTreeModule$$$ofSeq(comparer$$23, source$$3));
  }
  function groupBy(projection, xs, comparer$$24) {
    var mapping$$3;
    const dict = createMutable((0, _Seq.empty)(), comparer$$24);
    (0, _Seq.iterate)(function (v$$29) {
    ...
    return (mapping$$3 = function mapping$$3(kv$$3) {
      return [kv$$3[0], kv$$3[1]];
    }, function (source$$4) {
      return (0, _Seq.map)(mapping$$3, source$$4);
    })(dict);
  }
  function countBy(projection$$1, xs$$1, comparer$$25) {
    ...
    return (mapping$$4 = function mapping$$4(kv$$4) {
      return [kv$$4[0], kv$$4[1]];
    }, function (source$$5) {
      return (0, _Seq.map)(mapping$$4, source$$5);
    })(dict$$1);
  }
  function MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002ECollections$002EGeneric$002EIEnumerator$00601($this$$119) {
    return (0, _Util.extend)(MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002ECollections$002EIEnumerator($this$$119), MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002EIDisposable($this$$119), {
      [_Util.THIS_REF]: $this$$119,
  ...
  function MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002ECollections$002EIEnumerator($this$$120) {
    return {
      [_Util.THIS_REF]: $this$$120,
  ...
  function MapTreeModule$002EmkIEnumerator$0027$00602$$$System$002EIDisposable($this$$121) {
    return {
      [_Util.THIS_REF]: $this$$121,
