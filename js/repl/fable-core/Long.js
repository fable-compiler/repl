define(["exports", "./Int32", "./Util"], function (exports, _Int, _Util) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.MIN_VALUE = exports.MAX_UNSIGNED_VALUE = exports.MAX_VALUE = exports.NEG_ONE = exports.UONE = exports.ONE = exports.UZERO = exports.ZERO = exports.xor = exports.or = exports.and = exports.shr = exports.shl = exports.mod = exports.div = exports.mul = exports.sub = exports.add = exports.not = exports.neg = undefined;
    ...
    const neg = exports.neg = op_UnaryNegation;
    const not = exports.not = op_LogicalNot;
    const add = exports.add = op_Addition;
    const sub = exports.sub = op_Subtraction;
    const mul = exports.mul = op_Multiply;
    const div = exports.div = op_Division;
    const mod = exports.mod = op_Modulus;
    const shl = exports.shl = op_LeftShift;
    const shr = exports.shr = op_RightShift;
    const and = exports.and = op_BitwiseAnd;
    const or = exports.or = op_BitwiseOr;
    const xor = exports.xor = op_ExclusiveOr;
    ...
    function fromString(str, unsigned, radix) {
        if ((0, _Int.isValid)(str, radix) === null) {
