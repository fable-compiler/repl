...
export const BigNat = declare(function BigNat(arg1, arg2) {
  this.bound = arg1 | 0;
  this.digits = arg2;
}, Record);
export function BigNatModule$002EFFT$$$pow32(x, n$$1) {
  BigNatModule$002EFFT$$$pow32: while (true) {
    if (n$$1 === 0) {
      ...
      return x * BigNatModule$002EFFT$$$pow32(x * x, ~~(n$$1 / 2)) | 0;
    }
...
export function BigNatModule$002EFFT$002EFp$$$mpow(x$$3, n$$2) {
  BigNatModule$002EFFT$002EFp$$$mpow: while (true) {
    if (n$$2 === 0) {
      ...
      return toInt(op_Modulus(op_Multiply(fromInteger(x$$3, true, 6), fromInteger(BigNatModule$002EFFT$002EFp$$$mpow(toInt(op_Modulus(op_Multiply(fromInteger(x$$3, true, 6), fromInteger(x$$3, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0, ~~(n$$2 / 2)), true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
    }

    break;
  }
}
export function BigNatModule$002EFFT$002EFp$$$mpowL(x$$7, n$$3) {
  BigNatModule$002EFFT$002EFp$$$mpowL: while (true) {
    if (equals(n$$3, fromBits(0, 0, false))) {
      return BigNatModule$002EFFT$002EFp$$$mone;
    } else if (equals(op_Modulus(n$$3, fromBits(2, 0, false)), fromBits(0, 0, false))) {
      const $n$$3$$9 = n$$3;
      const $x$$7$$8 = x$$7;
      x$$7 = toInt(op_Modulus(op_Multiply(fromInteger($x$$7$$8, true, 6), fromInteger($x$$7$$8, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
      n$$3 = op_Division($n$$3$$9, fromBits(2, 0, false));
      continue BigNatModule$002EFFT$002EFp$$$mpowL;
    } else {
      return toInt(op_Modulus(op_Multiply(fromInteger(x$$7, true, 6), fromInteger(BigNatModule$002EFFT$002EFp$$$mpowL(toInt(op_Modulus(op_Multiply(fromInteger(x$$7, true, 6), fromInteger(x$$7, true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0, op_Division(n$$3, fromBits(2, 0, false))), true, 6)), BigNatModule$002EFFT$002EFp$$$p64)) >>> 0;
    }

    break;
  }
}
export function BigNatModule$002EFFT$002EFp$$$m2PowNthRoot(n$$4) {
  return BigNatModule$002EFFT$002EFp$$$mpow(BigNatModule$002EFFT$$$w >>> 0, BigNatModule$002EFFT$$$pow32(2, BigNatModule$002EFFT$$$k - n$$4));
}
...
export function BigNatModule$002EFFT$$$computeFFT(lambda, mu, n$$5, w, u, res, offset) {
  if (n$$5 === 1) {
    res[offset] = u[mu];
  } else {
    const halfN = ~~(n$$5 / 2) | 0;
...
export function BigNatModule$002EFFT$$$computFftInPlace(n$$6, w$$1, u$$1) {
  const lambda$$1 = 1;
  const mu$$1 = 0;
  const res$$1 = fill(new Uint32Array(n$$6), 0, n$$6, BigNatModule$002EFFT$002EFp$$$mzero);
  const offset$$1 = 0;
  BigNatModule$002EFFT$$$computeFFT(lambda$$1, mu$$1, n$$6, w$$1, u$$1, res$$1, offset$$1);
  return res$$1;
}
export function BigNatModule$002EFFT$$$computeInverseFftInPlace(n$$7, w$$2, uT) {
  const bigKInv = BigNatModule$002EFFT$002EFp$$$minv(n$$7 >>> 0);
  ...
  }, BigNatModule$002EFFT$$$computFftInPlace(n$$7, BigNatModule$002EFFT$002EFp$$$minv(w$$2), uT), Uint32Array);
}
...
export function BigNatModule$002EFFT$$$computeFftPaddedPolynomialProduct(bigK, k, u$$2, v) {
  ...
  const n$$8 = bigK | 0;
  const uT$$1 = BigNatModule$002EFFT$$$computFftInPlace(n$$8, w$$3, u$$2);
  const vT = BigNatModule$002EFFT$$$computFftInPlace(n$$8, w$$3, v);
  const rT = initialize(n$$8, function (i$$2) {
  ...
  const r = BigNatModule$002EFFT$$$computeInverseFftInPlace(n$$8, w$$3, rT);
  return r;
}
export function BigNatModule$002EFFT$$$padTo(n$$9, u$$3) {
  const uBound = u$$3.length | 0;
  return initialize(n$$9, function (i$$3) {
...
export function BigNatModule$002EFFT$$$computeFftPolynomialProduct(degu, u$$4, degv, v$$1) {
  ...
  const n$$10 = patternInput[0] | 0;
  const uT$$2 = BigNatModule$002EFFT$$$computFftInPlace(n$$10, w$$4, u$$5);
  const vT$$1 = BigNatModule$002EFFT$$$computFftInPlace(n$$10, w$$4, v$$2);
  const rT$$1 = initialize(n$$10, function (i$$4) {
  ...
  const r$$1 = BigNatModule$002EFFT$$$computeInverseFftInPlace(n$$10, w$$4, rT$$1);
...
export function BigNatModule$$$bound(n$$11) {
  return n$$11.bound;
}
export function BigNatModule$$$setBound(n$$12, v$$3) {
  n$$12.bound = v$$3;
}
export function BigNatModule$$$coeff(n$$13, i$$5) {
  return n$$13.digits[i$$5];
}
export function BigNatModule$$$coeff64(n$$14, i$$6) {
  return fromInteger(BigNatModule$$$coeff(n$$14, i$$6), false, 2);
}
export function BigNatModule$$$setCoeff(n$$15, i$$7, v$$4) {
  n$$15.digits[i$$7] = v$$4;
}
export function BigNatModule$$$pow64(x$$23, n$$16) {
  BigNatModule$$$pow64: while (true) {
    if (n$$16 === 0) {
      ...
      return op_Multiply(x$$23, BigNatModule$$$pow64(op_Multiply(x$$23, x$$23), ~~(n$$16 / 2)));
    }

    break;
  }
}
export function BigNatModule$$$pow32(x$$24, n$$17) {
  BigNatModule$$$pow32: while (true) {
    if (n$$17 === 0) {
      ...
      return x$$24 * BigNatModule$$$pow32(x$$24 * x$$24, ~~(n$$17 / 2)) | 0;
    }

    break;
  }
}
export function BigNatModule$$$hash(n$$18) {
  let res$$2 = 0;

  for (let i$$8 = 0; i$$8 <= n$$18.bound - 1; i$$8++) {
    res$$2 = n$$18.digits[i$$8] + (res$$2 << 3);
  }
...
export function BigNatModule$$$normN(n$$19) {
  ...
  const bound$$1 = findLeastBound(n$$19.digits, n$$19.bound - 1) | 0;
  n$$19.bound = bound$$1;
  return n$$19;
}
...
export function BigNatModule$$$eval32(n$$20) {
  if (n$$20.bound === 1) {
    return n$$20.digits[0] | 0;
  } else {
    let acc = 0;

    for (let i$$12 = n$$20.bound - 1; i$$12 >= 0; i$$12--) {
      acc = n$$20.digits[i$$12] + BigNatModule$$$baseN * acc;
    }

    return acc | 0;
  }
}
export function BigNatModule$$$eval64(n$$21) {
  if (n$$21.bound === 1) {
    return fromInteger(n$$21.digits[0], false, 2);
  } else {
    let acc$$1 = fromBits(0, 0, false);

    for (let i$$13 = n$$21.bound - 1; i$$13 >= 0; i$$13--) {
      acc$$1 = op_Addition(fromInteger(n$$21.digits[i$$13], false, 2), op_Multiply(BigNatModule$$$baseNi64, acc$$1));
    }
...
export function BigNatModule$$$restrictTo(d, n$$22) {
  return new BigNat(BigNatModule$$$minInt(d, n$$22.bound), n$$22.digits);
}
export function BigNatModule$$$shiftUp(d$$1, n$$23) {
  const m = BigNatModule$$$createN(n$$23.bound + d$$1);

  for (let i$$14 = 0; i$$14 <= n$$23.bound - 1; i$$14++) {
    m.digits[i$$14 + d$$1] = n$$23.digits[i$$14];
  }

  return m;
}
export function BigNatModule$$$shiftDown(d$$2, n$$24) {
  if (n$$24.bound - d$$2 <= 0) {
    return BigNatModule$$$zero;
  } else {
    const m$$1 = BigNatModule$$$createN(n$$24.bound - d$$2);

    for (let i$$15 = 0; i$$15 <= m$$1.bound - 1; i$$15++) {
      m$$1.digits[i$$15] = n$$24.digits[i$$15 + d$$2];
    }

    return m$$1;
  }
}
export function BigNatModule$$$degree(n$$25) {
  return n$$25.bound - 1;
}
export function BigNatModule$$$addP(i$$16, n$$26, c, p, q, r$$5) {
...
export function BigNatModule$$$subP(i$$19, n$$27, c$$2, p$$2, q$$2, r$$7) {
...
export const BigNatModule$002Eencoding = declare(function BigNatModule$002Eencoding(arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
  this.bigL = arg1 | 0;
...
export function BigNatModule$$$extractBits(n$$28, enc, bi) {
  const bj = bi + enc.bigL - 1 | 0;
  const biw = ~~(bi / BigNatModule$$$baseBits) | 0;
  const bjw = ~~(bj / BigNatModule$$$baseBits) | 0;

  if (biw !== bjw) {
    const x$$47 = (biw < n$$28.bound ? n$$28.digits[biw] : 0) | 0;
    const y$$17 = (bjw < n$$28.bound ? n$$28.digits[bjw] : 0) | 0;
    ...
    const x$$51 = (biw < n$$28.bound ? n$$28.digits[biw] : 0) | 0;
...
export function BigNatModule$$$decodeResultBits(enc$$2, poly$$1) {
  ...
  const rbits = BigNatModule$002EFFT$$$maxBitsInsideFp + enc$$2.bigL * n$$30 + 1 | 0;
  return rbits + 1 | 0;
}
...
export function BigNatModule$$$scaleSubInPlace(x$$57, f, a$$5, n$$31) {
  ...
  while (compare(z$$7, fromBits(0, 0, false)) > 0 ? true : j$$4 < patternInput$$3[1]) {
    ...
    invariant([z$$7, j$$4, n$$31]);
    let zLo = ~~toInt(op_BitwiseAnd(z$$7, BigNatModule$$$baseMaski64)) | 0;
    let zHi = op_Division(z$$7, BigNatModule$$$baseNi64);

    if (zLo <= patternInput$$2[0][j$$4 + n$$31]) {
      patternInput$$2[0][j$$4 + n$$31] = patternInput$$2[0][j$$4 + n$$31] - zLo;
    } else {
      patternInput$$2[0][j$$4 + n$$31] = patternInput$$2[0][j$$4 + n$$31] + (BigNatModule$$$baseN - zLo);
...
export function BigNatModule$$$scaleSub(x$$61, f$$2, a$$7, n$$32) {
  const freshx = BigNatModule$$$add(x$$61, BigNatModule$$$zero);
  BigNatModule$$$scaleSubInPlace(freshx, f$$2, a$$7, n$$32);
  return BigNatModule$$$normN(freshx);
}
export function BigNatModule$$$scaleAddInPlace(x$$62, f$$3, a$$8, n$$33) {
  ...
  while (compare(z$$8, fromBits(0, 0, false)) > 0 ? true : j$$5 < patternInput$$5[1]) {
    ...
    invariant$$1([z$$8, j$$5, n$$33]);
    let zLo$$1 = ~~toInt(op_BitwiseAnd(z$$8, BigNatModule$$$baseMaski64)) | 0;
    let zHi$$1 = op_Division(z$$8, BigNatModule$$$baseNi64);

    if (zLo$$1 < BigNatModule$$$baseN - patternInput$$4[0][j$$5 + n$$33]) {
      patternInput$$4[0][j$$5 + n$$33] = patternInput$$4[0][j$$5 + n$$33] + zLo$$1;
    } else {
      patternInput$$4[0][j$$5 + n$$33] = zLo$$1 - (BigNatModule$$$baseN - patternInput$$4[0][j$$5 + n$$33]);
...
export function BigNatModule$$$scaleAdd(x$$66, f$$5, a$$10, n$$34) {
  const freshx$$1 = BigNatModule$$$add(x$$66, BigNatModule$$$zero);
  BigNatModule$$$scaleAddInPlace(freshx$$1, f$$5, a$$10, n$$34);
  return BigNatModule$$$normN(freshx$$1);
}
export function BigNatModule$$$removeFactor(x$$67, a$$11, n$$35) {
  const patternInput$$6 = [BigNatModule$$$degree(a$$11), BigNatModule$$$degree(x$$67)];

  if (patternInput$$6[1] < patternInput$$6[0] + n$$35) {
    return 0;
  } else {
    ...
    if (patternInput$$6[0] === 0) {
      if (patternInput$$6[1] === n$$35) {
        f$$6 = ~~(patternInput$$7[1][n$$35] / patternInput$$7[0][0]);
      } else {
    ...
    } else if (patternInput$$6[1] === patternInput$$6[0] + n$$35) {
    ...
    if (f$$6 === 0) {
      const lte = BigNatModule$$$shiftCompare(a$$11, n$$35, x$$67, 0) !== 1;
...
export function BigNatModule$$$divmod(b$$7, a$$12) {
  if (BigNatModule$$$isZero(a$$12)) {
    ...
    while (!finished) {
      Invariant([d$$6, x$$68, n$$36, p$$21]);
      const f$$7 = BigNatModule$$$removeFactor(x$$68, a$$12, n$$36) | 0;

      if (f$$7 > 0) {
        BigNatModule$$$scaleSubInPlace(x$$68, f$$7, a$$12, n$$36);
        BigNatModule$$$scaleAddInPlace(d$$6, f$$7, BigNatModule$$$one, n$$36);
        Invariant([d$$6, x$$68, n$$36, p$$21]);
      } else {
        finished = f$$7 === 0 ? n$$36 === 0 : false;

        if (!finished) {
          if (p$$21 === m$$2 + n$$36) {
            Invariant([d$$6, x$$68, n$$36 - 1, p$$21]);
            n$$36 = n$$36 - 1;
          } else {
            Invariant([d$$6, x$$68, n$$36 - 1, p$$21 - 1]);
            n$$36 = n$$36 - 1;
            p$$21 = p$$21 - 1;
          }
        }
...
export function BigNatModule$$$powi(x$$69, n$$37) {
  const power = function power(acc$$2, x$$70, n$$38) {
    power: while (true) {
      if (n$$38 === 0) {
        return acc$$2;
      } else if (n$$38 % 2 === 0) {
  ...
  return power(BigNatModule$$$one, x$$69, n$$37);
}
export function BigNatModule$$$pow(x$$71, n$$39) {
  const power$$1 = function power$$1(acc$$3, x$$72, n$$40) {
    power$$1: while (true) {
      if (BigNatModule$$$isZero(n$$40)) {
        return acc$$3;
      } else {
        const patternInput$$9 = BigNatModule$$$divmod(n$$40, BigNatModule$$$two);
  ...
  return power$$1(BigNatModule$$$one, x$$71, n$$39);
}
export function BigNatModule$$$toFloat(n$$41) {
  ...
  const evalFloat = function evalFloat(acc$$4, k$$10, i$$47) {
    evalFloat: while (true) {
      if (i$$47 === n$$41.bound) {
        ...
        const $i$$47$$62 = i$$47;
        const $k$$10$$61 = k$$10;
        acc$$4 = $acc$$4$$60 + $k$$10$$61 * n$$41.digits[$i$$47$$62];
        k$$10 = $k$$10$$61 * basef;
        i$$47 = $i$$47$$62 + 1;
        continue evalFloat;
      }
...
export function BigNatModule$$$ofInt32(n$$42) {
  return BigNatModule$$$embed(n$$42);
}
export function BigNatModule$$$ofInt64(n$$43) {
  return BigNatModule$$$embed64(n$$43);
}
export function BigNatModule$$$toUInt32(n$$44) {
  const matchValue = n$$44.bound | 0;
  ...
  switch (matchValue) {
    ...
    case 1:
      {
        return n$$44.digits[0] >>> 0;
      }

    case 2:
      {
        const patternInput$$10 = [n$$44.digits[0], n$$44.digits[1]];
...
export function BigNatModule$$$toUInt64(n$$45) {
  const matchValue$$1 = n$$45.bound | 0;
  ...
  switch (matchValue$$1) {
    ...
    case 1:
      {
        return fromInteger(n$$45.digits[0], true, 2);
      }

    case 2:
      {
        const patternInput$$11 = [n$$45.digits[0], n$$45.digits[1]];
    ...
    case 3:
      {
        const patternInput$$12 = [n$$45.digits[0], n$$45.digits[1], n$$45.digits[2]];
...
export function BigNatModule$$$toString(n$$46) {
  const degn = BigNatModule$$$degree(n$$46) | 0;
  ...
  const collect = function collect(isLeading, digits, n$$47, _arg1$$3) {
    if (_arg1$$3.tail != null) {
      ...
      const patternInput$$13 = BigNatModule$$$divmod(n$$47, ten2k$$1);
      ...
      const n$$48 = BigNatModule$$$eval32(n$$47) | 0;
...
export function BigNatModule$$$isSmall(n$$49) {
  return n$$49.bound <= 1;
}
export function BigNatModule$$$getSmall(n$$50) {
  if (0 < n$$50.bound) {
    return n$$50.digits[0] | 0;
  } else {
    return 0;
  }
}
export function BigNatModule$$$factorial(n$$51) {
  ...
  return productR(BigNatModule$$$one, n$$51);
}