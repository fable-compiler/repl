define(["exports", "./Map", "./Set", "./Util"], function (exports, _Map, _Set, _Util) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.Attribute = exports.HashSet = exports.Dictionary = exports.MatchFailureException = exports.FSharpException = exports.Exception = exports.FSharpRef = undefined;
    ...
    const FSharpRef = exports.FSharpRef = declare(function FSharpRef(contents) {
        this.contents = contents;
    }, Record);
    // EXCEPTIONS
    const Exception = exports.Exception = declare(function Exception(msg) {
    ...
    const FSharpException = exports.FSharpException = declare(function FSharpException() {
        Exception.call(this);
    }, Exception);
    ...
    const MatchFailureException = exports.MatchFailureException = declare(function MatchFailureException(arg1, arg2, arg3) {
        this.arg1 = arg1;
        this.arg2 = arg2 | 0;
        this.arg3 = arg3 | 0;
    }, FSharpException);
    const Dictionary = exports.Dictionary = declare(function Dictionary(source, comparer) {
    ...
    const HashSet = exports.HashSet = declare(function HashSet(source, comparer) {
    ...
    const Attribute = exports.Attribute = declare(function Attribute() {});
});