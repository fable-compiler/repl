define(["exports", "./Date"], function (exports, _Date) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.compareTo = undefined;
    ...
    function create(year, month, day, h, m, s, ms, offset) {
        ...
        if (offset === 0) {
            ...
            const str = (0, _Date.padWithZeros)(year, 4) + "-" + (0, _Date.padWithZeros)(month, 2) + "-" + (0, _Date.padWithZeros)(day, 2) + "T" + (0, _Date.padWithZeros)(h, 2) + ":" + (0, _Date.padWithZeros)(m, 2) + ":" + (0, _Date.padWithZeros)(s, 2) + "." + (0, _Date.padWithZeros)(ms, 3) + (0, _Date.offsetToString)(offset);
            date = new Date(str);
        }
