...
export function MapTreeModule_mk(l, k, v, r) {
    ...
    if (m_2 === 0) {
        return new MapTreeLeaf$2_$ctor_5BDDA1(k, v);
    }
    else {
        return new MapTreeNode$2_$ctor_Z39DE9543(k, v, l, r, m_2 + 1);
    }
}
    ...
    if (m != null) {
        ...
        if (m2 instanceof MapTreeNode$2) {
            if (c < 0) {
                ...
                return new MapTreeNode$2_$ctor_Z39DE9543(k, v, MapTreeNode$2__get_Left(m2), MapTreeNode$2__get_Right(m2), MapTreeNode$2__get_Height(m2));
            }
            else {
            ...
            return new MapTreeNode$2_$ctor_Z39DE9543(k, v, MapTreeModule_empty(), m, 2);
        }
        else if (c === 0) {
            return new MapTreeLeaf$2_$ctor_5BDDA1(k, v);
        }
        else {
            return new MapTreeNode$2_$ctor_Z39DE9543(k, v, m, MapTreeModule_empty(), 2);
        }
    }
    else {
        return new MapTreeLeaf$2_$ctor_5BDDA1(k, v);
...
export function MapTreeModule_change(comparer, k, u, m) {
    if (m != null) {
        ...
        if (m2 instanceof MapTreeNode$2) {
            ...
            if (c < 0) {
                ...
                if (matchValue_1 != null) {
                    return new MapTreeNode$2_$ctor_Z39DE9543(k, value_1(matchValue_1), MapTreeNode$2__get_Left(m2), MapTreeNode$2__get_Right(m2), MapTreeNode$2__get_Height(m2));
                }
            ...
            if (c_1 < 0) {
                ...
                if (matchValue_2 != null) {
                    return new MapTreeNode$2_$ctor_Z39DE9543(k, value_1(matchValue_2), MapTreeModule_empty(), m, 2);
                }
                else {
                    return m;
                }
                ...
                if (matchValue_3 != null) {
                    return new MapTreeLeaf$2_$ctor_5BDDA1(k, value_1(matchValue_3));
                }
                else {
                    return MapTreeModule_empty();
                }
                ...
                if (matchValue_4 != null) {
                    return new MapTreeNode$2_$ctor_Z39DE9543(k, value_1(matchValue_4), m, MapTreeModule_empty(), 2);
                }
                else {
                    return m;
                }
        ...
        if (matchValue != null) {
            return new MapTreeLeaf$2_$ctor_5BDDA1(k, value_1(matchValue));
        }
        else {
            return m;
        }
...
export function MapTreeModule_map(f, m) {
    if (m != null) {
        ...
        if (m2 instanceof MapTreeNode$2) {
            ...
            return new MapTreeNode$2_$ctor_Z39DE9543(MapTreeLeaf$2__get_Key(m2), v2, l2, r2, MapTreeNode$2__get_Height(m2));
        }
        else {
            return new MapTreeLeaf$2_$ctor_5BDDA1(MapTreeLeaf$2__get_Key(m2), f(MapTreeLeaf$2__get_Value(m2)));
        }
    }
    else {
        return MapTreeModule_empty();
...
export function MapTreeModule_mapiOpt(f, m) {
    if (m != null) {
        ...
        if (m2 instanceof MapTreeNode$2) {
            ...
            return new MapTreeLeaf$2_$ctor_5BDDA1(MapTreeLeaf$2__get_Key(m2), f(MapTreeLeaf$2__get_Key(m2), MapTreeLeaf$2__get_Value(m2)));
        }
    }
    else {
        return MapTreeModule_empty();
    ...
    while (true) {
        ...
        if (!isEmpty_1(stack)) {
            ...
            if (m != null) {
                const m2 = m;
                if (m2 instanceof MapTreeNode$2) {
                    stack_mut = ofArrayWithTail([MapTreeNode$2__get_Left(m2), new MapTreeLeaf$2_$ctor_5BDDA1(MapTreeLeaf$2__get_Key(m2), MapTreeLeaf$2__get_Value(m2)), MapTreeNode$2__get_Right(m2)], rest);
...
export function FSharpMap_Empty(comparer) {
    return new FSharpMap_$ctor(comparer, MapTreeModule_empty());
}
...
export function FSharpMap__Add(m, key, value) {
    return new FSharpMap_$ctor(m.comparer, MapTreeModule_add(m.comparer, key, value, m.tree));
}

export function FSharpMap__Change(m, key, f) {
    return new FSharpMap_$ctor(m.comparer, MapTreeModule_change(m.comparer, key, f, m.tree));
}
...
export function FSharpMap__Filter(m, predicate) {
    return new FSharpMap_$ctor(m.comparer, MapTreeModule_filter(m.comparer, predicate, m.tree));
}
...
export function FSharpMap__MapRange(m, f) {
    return new FSharpMap_$ctor(m.comparer, MapTreeModule_map(f, m.tree));
}

export function FSharpMap__Map(m, f) {
    return new FSharpMap_$ctor(m.comparer, MapTreeModule_mapi(f, m.tree));
}

export function FSharpMap__Partition(m, predicate) {
    const patternInput = MapTreeModule_partition(m.comparer, predicate, m.tree);
    return [new FSharpMap_$ctor(m.comparer, patternInput[0]), new FSharpMap_$ctor(m.comparer, patternInput[1])];
}
...
export function FSharpMap__Remove(m, key) {
    return new FSharpMap_$ctor(m.comparer, MapTreeModule_remove(m.comparer, key, m.tree));
}
...
export function FSharpMap__ComputeHashCode(this$) {
    ...
    try {
        while (enumerator["System.Collections.IEnumerator.MoveNext"]()) {
            const activePatternResult8269 = enumerator["System.Collections.Generic.IEnumerator`1.get_Current"]();
            res = (combineHash(res, structuralHash(activePatternResult8269[0])) | 0);
            res = (combineHash(res, structuralHash(activePatternResult8269[1])) | 0);
        }
    }
    finally {
...
export function ofList(elements, comparer) {
    return new FSharpMap_$ctor(comparer, MapTreeModule_ofSeq(comparer, elements));
}
