...
export function Input$002EOption$reflection() {
  return union_type("Fulma.Radio.Input.Option", [], Input$002EOption, () => [["CustomClass", [["Item", string_type]]], ["Props", [["Item", list_type(class_type("Fable.React.Props.IHTMLProp"))]]], ["Name", [["Item", string_type]]], ["Modifiers", [["Item", list_type(Modifier$0024002EIModifier$0024reflection())]]]]);
}
