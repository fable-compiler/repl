...
export function cta(options$$2, children$$2) {
  ...
  return createElement("span", createObj(new List(classes$$1, opts$$1.Props), 1), ...children$$2);
}
export function name(options$$3, children$$4) {
  ...
  return createElement("span", createObj(new List(classes$$2, opts$$2.Props), 1), ...children$$4);
}
export function icon(options$$4, children$$6) {
  ...
  return createElement("span", createObj(new List(classes$$3, opts$$3.Props), 1), ...children$$6);
}
export function label(options$$5, children$$8) {
  ...
  return createElement("label", createObj(new List(classes$$4, opts$$4.Props), 1), ...children$$8);
}
