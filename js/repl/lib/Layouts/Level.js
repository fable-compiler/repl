...
export function heading(options$$6, children$$8) {
  ...
  return createElement("p", createObj(new List(classes$$4, opts$$4.Props), 1), ...children$$8);
}
export function title(options$$7, children$$10) {
  ...
  return createElement("p", createObj(new List(classes$$5, opts$$5.Props), 1), ...children$$10);
}
