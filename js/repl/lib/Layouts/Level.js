...
export function Level$002EOption$reflection() {
  return union_type("Fulma.Level.Level.Option", [], Level$002EOption, () => [["Props", [["Item", list_type(class_type("Fable.React.Props.IHTMLProp"))]]], "is-mobile", ["CustomClass", [["Item", string_type]]], ["Modifiers", [["Item", list_type(Modifier$0024002EIModifier$0024reflection())]]]]);
}
...
export function Item$002EOption$reflection() {
  return union_type("Fulma.Level.Item.Option", [], Item$002EOption, () => [["Props", [["Item", list_type(class_type("Fable.React.Props.IHTMLProp"))]]], "has-text-centered", ["CustomClass", [["Item", string_type]]], ["Modifiers", [["Item", list_type(Modifier$0024002EIModifier$0024reflection())]]]]);
}
