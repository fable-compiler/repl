...
export function Options$$$get_Empty() {
  return new Options(L(), false, null, null, null, L());
}
export function hero(options, children) {
  ...
  const classes = Common$0024002EHelpers$0024$0024$0024classes("hero", L(opts.Color, L(opts.Size, L(opts.CustomClass, opts.Modifiers))), L(["is-bold", opts.IsBold], L()));
...
export function head(options$$2, children$$2) {
  ...
  const classes$$1 = Common$0024002EHelpers$0024$0024$0024classes("hero-head", L(opts$$1.CustomClass, opts$$1.Modifiers), L());
...
export function body(options$$3, children$$4) {
  ...
  const classes$$2 = Common$0024002EHelpers$0024$0024$0024classes("hero-body", L(opts$$2.CustomClass, opts$$2.Modifiers), L());
...
export function foot(options$$4, children$$6) {
  ...
  const classes$$3 = Common$0024002EHelpers$0024$0024$0024classes("hero-foot", L(opts$$3.CustomClass, opts$$3.Modifiers), L());
...
export function video(options$$5, children$$8) {
  ...
  const classes$$4 = Common$0024002EHelpers$0024$0024$0024classes("hero-video", L(opts$$4.CustomClass, opts$$4.Modifiers), L());
...
export function buttons(options$$6, children$$10) {
  ...
  const classes$$5 = Common$0024002EHelpers$0024$0024$0024classes("hero-buttons", L(opts$$5.CustomClass, opts$$5.Modifiers), L());
  return createElement("div", createObj(L(classes$$5, opts$$5.Props), 1), ...children$$10);
}
