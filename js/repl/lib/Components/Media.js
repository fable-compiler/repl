...
export function media(options, children) {
  ...
  const classes = Common$0024002EHelpers$0024$0024$0024classes("media", L(opts.Size, L(opts.CustomClass, opts.Modifiers)), L());
...
export function left(options$$2, children$$2) {
  ...
  const classes$$1 = Common$0024002EHelpers$0024$0024$0024classes("media-left", L(opts$$1.CustomClass, opts$$1.Modifiers), L());
  return createElement("figure", createObj(L(classes$$1, opts$$1.Props), 1), ...children$$2);
}
export function right(options$$3, children$$4) {
  const opts$$2 = Common$0024$0024$0024genericParse(options$$3);
  const classes$$2 = Common$0024002EHelpers$0024$0024$0024classes("media-right", L(opts$$2.CustomClass, opts$$2.Modifiers), L());
...
export function content(options$$4, children$$6) {
  ...
  const classes$$3 = Common$0024002EHelpers$0024$0024$0024classes("media-content", L(opts$$3.CustomClass, opts$$3.Modifiers), L());
