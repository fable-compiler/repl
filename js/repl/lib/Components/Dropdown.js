...
export function Options$$$get_Empty() {
  return new Options(L(), false, false, false, false, null, L());
}
export function dropdown(options, children) {
  ...
  const classes = Common$0024002EHelpers$0024$0024$0024classes("dropdown", L(opts.CustomClass, opts.Modifiers), L(["is-right", opts.IsRight], L(["is-active", opts.IsActive], L(["is-hoverable", opts.IsHoverable], L(["is-up", opts.IsUp], L())))));
...
export function menu(options$$3, children$$2) {
  ...
  const classes$$1 = Common$0024002EHelpers$0024$0024$0024classes("dropdown-menu", L(opts$$1.CustomClass, opts$$1.Modifiers), L());
...
export function content(options$$4, children$$4) {
  ...
  const classes$$2 = Common$0024002EHelpers$0024$0024$0024classes("dropdown-content", L(opts$$2.CustomClass, opts$$2.Modifiers), L());
...
export function divider(options$$5) {
  ...
  const classes$$3 = Common$0024002EHelpers$0024$0024$0024classes("dropdown-divider", L(opts$$3.CustomClass, opts$$3.Modifiers), L());
  return createElement("hr", createObj(L(classes$$3, opts$$3.Props), 1), ...L());
}
...
export function Item$$$item(element, options$$6, children$$6) {
  ...
  const classes$$4 = Common$0024002EHelpers$0024$0024$0024classes("dropdown-item", L(opts$$4.CustomClass, opts$$4.Modifiers), L(["is-active", opts$$4.IsActive], L()));
  return element(L(classes$$4, opts$$4.Props), children$$6);
}
