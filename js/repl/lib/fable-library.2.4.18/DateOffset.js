...
export function create(year, month, day, h, m, s, ms, offset) {
  ...
  if (offset === 0) {
    ...
    const str = padWithZeros(year, 4) + "-" + padWithZeros(month, 2) + "-" + padWithZeros(day, 2) + "T" + padWithZeros(h, 2) + ":" + padWithZeros(m, 2) + ":" + padWithZeros(s, 2) + "." + padWithZeros(ms, 3) + dateOffsetToString(offset);
    date = new Date(str);
  }
...
export function subtract(d, that) {
  ...
  return typeof that === "number" ? DateTimeOffset(d.getTime() - that, (_a = d.offset, _a !== null && _a !== void 0 ? _a : 0)) : d.getTime() - that.getTime();
}
