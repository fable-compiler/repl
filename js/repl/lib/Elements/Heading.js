...
export function Options$$$get_Empty() {
  return new Options(null, "title", false, null, L(), L());
}
export function title(element, options, children) {
  ...
  const classes = Common$0024002EHelpers$0024$0024$0024classes(opts.TitleType, L(opts.TitleSize, L(opts.CustomClass, opts.Modifiers)), L(["is-spaced", opts.IsSpaced], L()));
...
export function h1(options$$2) {
  return function (children$$2) {
    ...
    }, L(new Option(0, "Is1"), options$$2), children$$2);
  };
}
export function h2(options$$4) {
  return function (children$$4) {
    ...
    }, L(new Option(1, "Is2"), options$$4), children$$4);
  };
}
export function h3(options$$6) {
  return function (children$$6) {
    ...
    }, L(new Option(2, "Is3"), options$$6), children$$6);
  };
}
export function h4(options$$8) {
  return function (children$$8) {
    ...
    }, L(new Option(3, "Is4"), options$$8), children$$8);
  };
}
export function h5(options$$10) {
  return function (children$$10) {
    ...
    }, L(new Option(4, "Is5"), options$$10), children$$10);
  };
}
export function h6(options$$12) {
  return function (children$$12) {
    ...
    }, L(new Option(5, "Is6"), options$$12), children$$12);
  };
}
