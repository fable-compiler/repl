import { mapIndexed, map as map$$1, fold, iterate } from "../fable-library.2.1.8/Seq.js";
import { empty, tryFind, toList } from "../fable-library.2.1.8/Map.js";
import { toString as toString$$1 } from "../fable-library.2.1.8/Date.js";
import { toString as toString$$2 } from "../fable-library.2.1.8/Long.js";
import { comparePrimitives, uncurry } from "../fable-library.2.1.8/Util.js";
import { defaultArgWith, defaultArg } from "../fable-library.2.1.8/Option.js";
import { type, getGenerics, getGenericTypeDefinition, getTupleFields, getTupleElements, isTuple, isGenericType, getElementType, isArray, fullName, getUnionCaseFields, getUnionFields, isUnion, getRecordElements, getRecordField, name, isRecord } from "../fable-library.2.1.8/Reflection.js";
import { fill, map } from "../fable-library.2.1.8/Array.js";
import { toFail, printf } from "../fable-library.2.1.8/String.js";
import { declare } from "../fable-library.2.1.8/Types.js";
