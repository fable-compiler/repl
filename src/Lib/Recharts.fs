module Fable.Repl.Lib.Recharts
...
module Props =
    ...
    type [<RequireQualifiedAccess>] Chart =
        ...
        interface Fable.Repl.Lib.React.Props.IProp
...
open Fable.Repl.Lib.React
open Props

let [<Global>] private Recharts = obj()
let inline private ofImport (importMember: string) (_importPath: string) (props: 'P) (children: ReactElement seq): ReactElement =
    React.createElement(Recharts?(importMember), props, children)

// Charts
let lineChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "LineChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let barChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "BarChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let areaChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "AreaChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let composedChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ComposedChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let pieChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "PieChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let radarChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "RadarChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let radialBarChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "RadialBarChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let scatterChart (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ScatterChart" "recharts" (keyValueList CaseRules.LowerFirst props) children

let treemap (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Treemap" "recharts" (keyValueList CaseRules.LowerFirst props) children

// General Components

let responsiveContainer (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ResponsiveContainer" "recharts" (keyValueList CaseRules.LowerFirst props) children

let legend (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Legend" "recharts" (keyValueList CaseRules.LowerFirst props) children

let tooltip (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Tooltip" "recharts" (keyValueList CaseRules.LowerFirst props) children

let cell (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Cell" "recharts" (keyValueList CaseRules.LowerFirst props) children

let text (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Text" "recharts" (keyValueList CaseRules.LowerFirst props) children

let label (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Label" "recharts" (keyValueList CaseRules.LowerFirst props) children

let labelList (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "LabelList" "recharts" (keyValueList CaseRules.LowerFirst props) children

// Cartesian Components
let area (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Area" "recharts" (keyValueList CaseRules.LowerFirst props) children

let bar (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Bar" "recharts" (keyValueList CaseRules.LowerFirst props) children

let line (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Line" "recharts" (keyValueList CaseRules.LowerFirst props) children

let scatter (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Scatter" "recharts" (keyValueList CaseRules.LowerFirst props) children

let xaxis (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "XAxis" "recharts" (keyValueList CaseRules.LowerFirst props) children

let yaxis (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "YAxis" "recharts" (keyValueList CaseRules.LowerFirst props) children

let zaxis (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ZAxis" "recharts" (keyValueList CaseRules.LowerFirst props) children

let brush (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Brush" "recharts" (keyValueList CaseRules.LowerFirst props) children

let cartesianAxis (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "CartesianAxis" "recharts" (keyValueList CaseRules.LowerFirst props) children

let cartesianGrid (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "CartesianGrid" "recharts" (keyValueList CaseRules.LowerFirst props) children

let referenceLine (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ReferenceLine" "recharts" (keyValueList CaseRules.LowerFirst props) children

let referenceDot (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ReferenceDot" "recharts" (keyValueList CaseRules.LowerFirst props) children

let referenceArea (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ReferenceArea" "recharts" (keyValueList CaseRules.LowerFirst props) children

let errorBar (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "ErrorBar" "recharts" (keyValueList CaseRules.LowerFirst props) children


// Polar Components
let pie (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Pie" "recharts" (keyValueList CaseRules.LowerFirst props) children

let radar (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "Radar" "recharts" (keyValueList CaseRules.LowerFirst props) children

let radialBar (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "RadialBar" "recharts" (keyValueList CaseRules.LowerFirst props) children

let polarAngleAxis (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "PolarAngleAxis" "recharts" (keyValueList CaseRules.LowerFirst props) children

let polarGrid (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "PolarGrid" "recharts" (keyValueList CaseRules.LowerFirst props) children

let polarRadiusAxis (props: IProp seq) (children: React.ReactElement seq): React.ReactElement =
    ofImport "PolarRadiusAxis" "recharts" (keyValueList CaseRules.LowerFirst props) children

// Shapes
let cross (props: IProp seq): React.ReactElement =
    ofImport "Cross" "recharts" (keyValueList CaseRules.LowerFirst props) []

let curve (props: IProp seq): React.ReactElement =
    ofImport "Curve" "recharts" (keyValueList CaseRules.LowerFirst props) []

let dot (props: IProp seq): React.ReactElement =
    ofImport "Dot" "recharts" (keyValueList CaseRules.LowerFirst props) []

let polygon (props: IProp seq): React.ReactElement =
    ofImport "Polygon" "recharts" (keyValueList CaseRules.LowerFirst props) []

let rectangle (props: IProp seq): React.ReactElement =
    ofImport "Rectangle" "recharts" (keyValueList CaseRules.LowerFirst props) []

let sector (props: IProp seq): React.ReactElement =
