...
module TranslationsSupport =
    ...
    let ukTranslations = 
        {| msg_iframe_loaded = "Iframe завантажено";
           ...
           msg_general_reset_repl_tooltip = "Скиньте REPL, ви втратите поточну роботу";
           msg_general_reset_repl_text = "Скиньте REPL, ви втратите поточну роботу";
    ...
    let translations = dict["en", enTranslations;"uk", ukTranslations;]
