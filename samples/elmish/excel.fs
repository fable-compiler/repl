...
module Elmish =
    ...
    module Virtualdom =
      ...
      let inline h(arg1: string, arg2: obj, arg3: obj[]): obj = virtualDom.h(arg1, arg2, arg3)
      let inline diff (tree1:obj) (tree2:obj): obj = virtualDom.diff(tree1, tree2)
      let inline patch (node:obj) (patches:obj): Node = virtualDom.patch(node, patches)
      let inline createElement (e:obj): Node = virtualDom.createElement(e)
